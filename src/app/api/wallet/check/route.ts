...
export async function GET() {
  try {
    ...
    return NextResponse.json({ ok: createRes.ok, step: createRes.ok ? 'class_created' : 'class_create_failed', classId, issuerId, createStatus: createRes.status, result: createData })
  } catch (err: any) {
